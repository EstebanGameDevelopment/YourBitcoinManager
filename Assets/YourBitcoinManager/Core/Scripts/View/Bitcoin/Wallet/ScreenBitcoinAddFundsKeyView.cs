...
namespace YourBitcoinManager
{
	...
	public class ScreenBitcoinAddFundsKeyView : ScreenBaseView, IBasicScreenView
	{
		...
		private void OnEnterBitcoins()
		{
			...
			ScreenController.Instance.CreateNewInformationScreen(ScreenInformationView.SCREEN_INFORMATION, TypePreviousActionEnum.KEEP_CURRENT_SCREEN, title, description, null, SUBEVENT_CONFIRMATION_OPEN_URL_TO_ADD_BITCOINS);
		}
		...
		private void OnWithdrawBitcoins()
		{
			...
			ScreenController.Instance.CreateNewInformationScreen(ScreenInformationView.SCREEN_INFORMATION, TypePreviousActionEnum.KEEP_CURRENT_SCREEN, pages);			
		}
