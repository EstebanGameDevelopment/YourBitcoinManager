...
namespace YourBitcoinManager
{
	 ...
	 */
	public class ScreenSingleImageView : ScreenBaseView, IBasicScreenView
	{
		...
		public void Initialize(params object[] _list)
		{
			...
			ImageUtilities.LoadBytesImage(m_imageContent, m_binaryDataImage, (int)m_imageContent.GetComponent<RectTransform>().sizeDelta.y, SIZE_ALLOWED);
