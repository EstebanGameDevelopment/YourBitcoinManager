...
namespace YourBitcoinManager
{
	...
	public class ButtonEventCustom : Button
	{
		...
		public override void OnPointerDown(PointerEventData eventData)
		{
			...
			BasicEventController.Instance.DispatchBasicEvent(EVENT_BUTTON_CUSTOM_PRESSED_DOWN, this.gameObject);
		}
		...
		public override void OnPointerUp(PointerEventData eventData)
		{
			...
			BasicEventController.Instance.DispatchBasicEvent(EVENT_BUTTON_CUSTOM_RELEASE_UP, this.gameObject);
		}
